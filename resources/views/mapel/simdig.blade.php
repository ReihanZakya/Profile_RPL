<table class="table table-hover table-striped table-bordered pd">
    ...
    <tbody>
        ...
        <tr>
            <td><b>3.10</b> Menganalisis komunikasi
             sinkron dan asinkron dalam
             jaringan</td>
            <td><b>4.10</b> Melakukan komunikasi
             sinkron dan asinkron dalam
             jaringan</td>
        </tr>
        <tr>
            <td><b>3.11</b> Menganalisis fitur perangkat
             lunak pembelajaran
             kolaboratif daring</td>
            <td><b>4.11</b> Menggunakan fitur untuk
             pembelajaran kolaboratif
             daring (kelas maya)</td>
        </tr>
        <tr>
            <td><b>3.12</b> Merancang dokumen tahap
             pra-produksi</td>
            <td><b>4.12</b> Membuat dokumen tahap
             pra-produksi</td>
        </tr>
        <tr>
            <td><b>3.13</b> Menganalisis produksi video,
             animasi dan/atau musik
             digital</td>
            <td><b>4.13</b> Memroduksi video dan/atau
             animasi dan/atau musik
             digital</td>
        </tr>
        <tr>
            <td><b>3.14</b> Mengevaluasi pasca-produksi
             video, animasi dan/atau
             musik digital</td>
            <td><b>4.14</b> Membuat laporan hasil
             pasca-produksi</td>
        </tr>
    </tbody>
</table>
