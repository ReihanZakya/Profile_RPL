...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ $title }}
            <a href="{{ url('portfolio_member/add') }}" class="btn btn-primary btn-sm float-right">Tambah Portofolio</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-danger btn-sm btn-outline-light delete"
                                    data-id="{{ $dt->pm }}" data-nama="{{ $dt->member_name }}">Hapus</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
...
@push('confirmation')
    ...
    <script>
        ...
        $('.delete').click(function() {
            ...
            swal({
                    title: "Yakin?",
                    text: "Apaka anda akan menghapus data dengan nama " + nama + " ?",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
