            ...
            <div class="card-body">
                ...
                <div class="custom-control custom-radio mb-2">
                    <input type="radio" class="custom-control-input @error('teacher_id') is-invalid @enderror"
                        id="customControlValidation{{ $tc->id }}" name="teacher_id" value="{{ $tc->id }}" @if (old('teacher_id',$dt->id) == $tc->id) checked @endif>
                ...
                @endforeach
                 ...
                 <div class="custom-control custom-radio mb-2">
                     <input type="radio" class="custom-control-input @error('subject_id') is-invalid @enderror"
                         id="customControlValidation{{ $sc->id+100 }}" name="subject_id" value="{{ $sc->id }}" @if (old('subject_id',$dt->id) == $sc->id) checked @endif>
