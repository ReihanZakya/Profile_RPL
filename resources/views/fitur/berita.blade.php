...
@section('content')
    ...
    <div id="carouselExampleControls" class="carousel slide " data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <a href="{{ url('RPL/berita1') }}"
                    class="link {{ url()->current() == url('RPL/berita1') ? 'active' : '' }}">
            ...
            <div class="carousel-item">
                <a href="{{ url('RPL/berita2') }}"
                    class="link {{ url()->current() == url('RPL/berita2') ? 'active' : '' }}">
            ...
            <div class="carousel-item">
                <a href="{{ url('RPL/berita3') }}"
                    class="link {{ url()->current() == url('RPL/berita3') ? 'active' : '' }}">
    ...
    <button class="carousel-control-prev prev-button" type="button" data-bs-target="#carouselExampleControls"
        data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden ">Previous</span>
    </button>
    <button class="carousel-control-next next-button" type="button" data-bs-target="#carouselExampleControls"
        data-bs-slide="next">
    ...
    <div class="container mt-5">
        <div class="row g-3">
            ...
            <div class="col-md-4 col-sm-12 mb-3">
                <div class="card shadow-sm garis">
                    <img src="{{ asset('assets/img/sunburst.png') }}" class="card-img" alt=""
                        class="bd-placeholder-img card-img-top" width="100%" height="232" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-dark"><a href="{{ url('RPL/berita1') }}"
                                class="link {{ url()->current() == url('RPL/berita1') ? 'active' : '' }}"
                                style="font-size: 14px; color: orange;">SELENGKAPNYA</button>
                        <a></a>
                    </div>
            ...
            <div class="col-md-4 col-sm-12 mb-3">
                <div class="card shadow-sm garis">
                    <img src="{{ asset('assets/img/hacker4.png') }}" alt="" class="bd-placeholder-img card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-dark"><a href="{{ url('RPL/berita2') }}"
                                class="link {{ url()->current() == url('RPL/berita2') ? 'active' : '' }}"
                                style="font-size: 14px; color: orange;">SELENGKAPNYA</button>
            ...
            <div class="col-md-4 col-sm-12 mb-3">
                <div class="card shadow-sm garis">
                    <img src="{{ asset('assets/img/hacker3.png') }}" alt="" class="bd-placeholder-img card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-dark"><a href="{{ url('RPL/berita3') }}"
                                class="link {{ url()->current() == url('RPL/berita3') ? 'active' : '' }}"
                                style="font-size: 14px; color: orange;">SELENGKAPNYA</button>
