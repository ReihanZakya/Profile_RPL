            ...
            <div class="col-md-4 col-sm-12 mb-3">
                <div class="card shadow-sm garis">
                    ...
                    <div class="card-body" style="margin:5px;">
                        ...
                        <button type="button" class="btn btn-primary"><a href="{{ url('RPL/berita1') }}"
                                class="link {{ url()->current() == url('RPL/berita1') ? 'active' : '' }}"
                                style="font-size: 14px; color: white;">SELENGKAPNYA</button>
                        <!-- </button> -->
                        <a></a>
                    </div>
...
<div id="carouselExampleControls" class="carousel slide " data-bs-ride="carousel">
  ...
  <button class="carousel-control-prev prev-button" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    <span class="visually-hidden ">Previous</span>
  </button>
  <button class="carousel-control-next next-button" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    <span class="carousel-control-next-icon" aria-hidden-="true"></span>
    <span class="visually-hidden">Next</span>
  </button>
</div>
            ...
            <div class="col-md-4 col-sm-12 mb-3">
                <div class="card shadow-sm garis">
                    ...
                    <div class="card-body" style="margin: 5px;">
                        ...
                        <button type="button" class="btn btn-primary"><a href="{{ url('RPL/berita2') }}"
                                class="link {{ url()->current() == url('RPL/berita2') ? 'active' : '' }}"
                                style="font-size: 14px; color: white;">SELENGKAPNYA</button>
            ...
            <div class="col">
                <div class="card shadow-sm garis">
                    ...
                    <div class="card-body" style="margin: 5px;">
                        ...
                        <button type="button" class="btn btn-primary"><a href="{{ url('RPL/berita3') }}"
                                class="link {{ url()->current() == url('RPL/berita3') ? 'active' : '' }}"
                                style="font-size: 14px; color: white;">SELENGKAPNYA</button>
