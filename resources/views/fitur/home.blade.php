    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 content" data-aos="fade-left" data-aos-delay="100">
          ...
          <h5 class="mb-3">Kelas X</h5>
          <ul>
            <li>
                <button class="btn btn-primary btn-sm btn-light pdx" type="button">
                    Pemrograman Dasar
                  </button>
                </p>
            ...
            <li>
                <button class="btn btn-primary btn-sm btn-light komjarx" type="button">
                    Teknik Komputer Jaringan
                  </button>
                </p>
                <div class="collapse mt-3" id="komjarx">
                    <div class="table-responsive">
            ...
            <li>
                <button class="btn btn-primary btn-sm btn-light siskomx" type="button">
                    Sistem Komputer
                  </button>
                </p>
            ...
            <li>
                <button class="btn btn-primary btn-sm btn-light simdigx">
                    Simulasi Digital
                  </button>
                </p>
