            ...
            <div class="row justify-content-center">
                <div class="col-lg-2 col-md-6 d-flex align-items-stretch">
                    <div class="member" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <center>
                            <button type="button" class="btn btn-danger" style="margin-top: 5px;" data-bs-toggle="modal"
                                data-bs-target="#pakrey">
                                Mata Pelajaran
                            </button>
                ...
                <div class="modal-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">2</th>
                                <td>Pemrograman Berorientasi Objek (KELAS XI)</td>
                            </tr>
                            <tr>
                                <th scope="row">3</th>
                                <td>Pemrograman Berorientasi Objek (KELAS XII)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
