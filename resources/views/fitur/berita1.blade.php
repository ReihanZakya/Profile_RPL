...
<div class="container" data-aos="fade-up">
            ...
            <h5 style="text-align: justify;">Target utama peretasan ini besar kemungkinan adalah pemerintah AS.
            ...
            <div class="container" data-aos="fade-up">
            <div>
            <p style="font-size: 25px; "><b>Serangan rantai pasokan</b></p>
            <h5 style="text-align: justify;">Sejumlah ahli mengatakan bahwa metode para peretas untuk mendapatkan akses sangat mengkhawatirkan keamanan nasional.

            "Pemerintah tidak siap untuk bersaing dengan Silicon Valley dan mengembangkan rangkaian perangkat lunak mereka sendiri yang kompleks, sehingga bergantung pada rantai pasokan eksternal, yang menjadi target peretas," kata Jackie Singh, yang merupakan pakar keamanan siber terkemuka di tim kampanye Joe Biden dan pendiri Spyglass Security.Singh mengatakan "jika sekelompok peretas yang memiliki dana besar bisa berhasil memodifikasi sebagian kode saja di suatu tempat, yang kemudian diunduh orang-orang -- sebagai bagian dari rangkaian perangkat lunak yang resmi -- mereka memperoleh akses ke dalam organisasi-organisasi yang kemungkinan semesterinya tidak dapat ditembus, seperti misalnya pemerintah".
            ...
            Tim-tim keamanan di semua organisasi yang terkena dampak bisa perlu waktu berbulan-bulan untuk mencoba mencari tahu email apa yang dibaca, dokumen yang dicuri, atau kata sandi yang bocor dalam peretasan mereka.Belum diketahui, dan kita mungkin tidak akan pernah diberi tahu, informasi pemerintah macam apa yang dicuri, tapi Lord mengatakan pesan-pesan yang paling rahasia semestinya tetap aman.
            ...
            <button  type="button" class="btn btn-warning mt-3" style="margin-bottom: 20px;">
            <a href="{{url('RPL/berita')}}" style="color: black;">Kembali</a>
            </button>
            </div>
