    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0 ">
            <ul class="nav ml-auto">
                <li class="nav-item"><a class="link {{ url()->current() == url('/') ? 'active' : '' }}" href="/" style="font-size: 14px;">Beranda</a></li>
                <li class="nav-item"><a href="{{ url('RPL/berita') }}"
                        class="link {{ url()->current() == url('RPL/berita') ? 'active' : '' }}" style="font-size: 14px;">Berita</a></li>
                ...
                <li class="nav-item"><a href="{{ url('RPL/contact') }}"
                        class="link {{ url()->current() == url('RPL/contact') ? 'active' : '' }}" style="font-size: 14px;">Kontak</a></li>        
                </li>
            </ul>
